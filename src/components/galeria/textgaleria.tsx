...
const TextGaleria: React.FC = () => {
  return (
    <div className="mx-auto text-center mb-12 px-12 lg:px-4 animate-fade-in-up">
      <h2 className="text-4xl md:text-5xl font-bold text-blue-900 text-left mb-4 animate-fade-in-up font-title" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
        Galeria
      </h2>
      <div className="flex flex-col justify-between text-left items-start">
        <h3 className="text-lg md:text-xl text-gray-600 text-left mb-2 animate-fade-in-up font-subtitle" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
